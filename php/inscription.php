...
function ll_aff_formulaire($erreurs) {
    ...
    echo '<table>';
    ll_aff_ligne_input('text', 'Choisissez un pseudo :', 'pseudo', $pseudo, array('placeholder' => '4 caractères minimum', 'required' => 0));
    ...
    ll_aff_input_checkbox('J\'ai lu et j\'accepte les conditions générales d\'utilisation', 'cbCGU', 1, array('required' => 0));
